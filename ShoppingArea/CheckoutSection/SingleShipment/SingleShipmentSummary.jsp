	...
	<head>
		...
		<script type="text/javascript">
			dojo.addOnLoad(function() {
				...
				<%-- Harish Starts : Added Loyalty related Message setup --%>
				MessageHelper.setMessage("ERROR_EMPTY_LOYALTY_AMOUNT", <wcf:json object="${ERROR_EMPTY_LOYALTY_AMOUNT}"/>);
				MessageHelper.setMessage("ERROR_EXCEEDED_LOYALTY_AMOUNT", <wcf:json object="${ERROR_EXCEEDED_LOYALTY_AMOUNT}"/>);
				MessageHelper.setMessage("ERROR_EXCEEDED_TOTAL_AMOUNT", <wcf:json object="${ERROR_EXCEEDED_TOTAL_AMOUNT}"/>);
				<%-- Harish Ends : Added Loyalty related Message setup --%>
									...
									<div id="box">
										...
										<div class="body shipping_billing_height" id="WC_SingleShipmentSummary_div_13">
											...
											<div class="button_footer_line" id="WC_SingleShipmentSummary_div_31_1">
												...
												<%-- Harish Strats : Added this for salesCommission --%>
												<input type="hidden" id="WC_SingleShipmentSummary_links_4b_addressId" value="${billingAddressId}"/>
												<input type="hidden" id="WC_SingleShipmentSummary_links_4b_userId" value="${userId}"/>
												<input type="hidden" id="WC_SingleShipmentSummary_links_4b_userType" value="${userType}"/>
												<%-- <input type="hidden" id="WC_SingleShipmentSummary_links_4b_employeeId" value="${person.businessProfile.employeeID}"/> --%>
												<input type="hidden" id="WC_SingleShipmentSummary_links_4b_employeeId" value=""/>
												<input type="hidden" id="WC_SingleShipmentSummary_links_4b_orderId" value="${order.orderId}"/>
												<c:forEach var="paymentInstance1" items="${order.paymentInstruction}" varStatus="paymentCount">
													<input type="hidden" id="WC_SingleShipmentSummary_links_4b_paymentName" value="${paymentInstance1.payMethodId}"/>
												</c:forEach>
												<%-- Harish Ends : Added this for salesCommission --%>
